...
class DlgIncreaseCard extends AWidgetDlg {
    ...
    return <div className='static-modal'>
      <Modal.Dialog>
        ...
        <Modal.Footer>
          ...
          <Button id='btnOk' onClick={this.handleOk} bsStyle='primary'>Начислить</Button>
        </Modal.Footer>
...
DlgIncreaseCard.propTypes = {
  modalType: React.PropTypes.string.isRequired,
  doc: React.PropTypes.object.isRequired
};

DlgIncreaseCard.defaultProps = {
  modalType: '',
  doc: { n: 0 }
};

export default DlgIncreaseCard;
