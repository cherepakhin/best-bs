...
describe('Test DLG_PAYMENT', () => {
    ...
    it('Определение create', () => {
      expect(dlg._actions.fnOk).toBeDefined();
      expect(dlg._actions.fnOk).toEqual(actions.create);
    });
    ...
    it('Определение typeDlg', () => {
      ...
      expect(dlg.typeDlg).toEqual(CONST_ACTION.DLG_PAYMENT);
    });

    it('Определение title', () => {
      expect(dlg.title).toBeDefined();
      expect(dlg.title).toEqual('Оплата');
    });
